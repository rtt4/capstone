...
function gui_addArea(id) {
   ...
   if (document.getElementById('dd_output').value != 'css') {
      temp+= '<option value="rect">circle</option>';
      temp+= '<option value="poly">poly</option>';
   }

   temp+= '</select>';
   temp+= '   Type: <select name="img_target" class="img_target">';
   temp+= ' <option selected disabled hidden>Choose Type</option>';
   temp+= '<option value="0">sel_question</option>';
   temp+= '<option value="1" >sel_answer</option>';
   temp+= '</select>';
...
if(pid < 0){
   ...
   temp2+= '<select name="img_shape" class="img_shape">';
   temp2+= '<option value="rect">rectangle</option>';
   if (document.getElementById('dd_output').value != 'css') {
      temp2+= '<option value="rect">circle</option>';
      temp2+= '<option value="poly">poly</option>';
   }

   temp2+= '</select>';
   temp2+= '   Type: <select name="img_target" class="img_target">';
   temp2+= '<option value="0" selected >sel_question</option>';
   temp2+= '<option value="1" >sel_answer</option>';
   temp2+= '</select>';
